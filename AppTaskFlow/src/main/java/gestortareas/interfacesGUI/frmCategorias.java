...
public class frmCategorias extends javax.swing.JFrame {
     ...
     */
    public frmCategorias(javax.swing.JFrame ventanaAnterior) {
        initComponents();
    ...
    private void configurarVentana() {
        ...
        this.setTitle("TaskFlow - Categorías");
    }
    ...
    private void navegarAInicio() {
        try {
            ...
            pantallaPrincipal.setLocationRelativeTo(null); // Centrar ventana
    ...
    private void navegarATareas() {
        try {
            frmTareasGeneral tareas = new frmTareasGeneral();
            tareas.setVisible(true);
            tareas.setLocationRelativeTo(null); // Centrar ventana
            this.dispose(); // Cerrar ventana actual
        } catch (Exception ex) {
            javax.swing.JOptionPane.showMessageDialog(this, 
    ...
    private void navegarAExportar() {
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Error al abrir exportar: " + ex.getMessage(),
                "Error", 
                javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
